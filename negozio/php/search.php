                ...
                if ($result) {
                    ...
                    <th>Data di nascita</th>
                        ...
                        while ($row = mysqli_fetch_row($result)) {
                            ...
                            echo '<tbody>
                    <tr>
                        <td class="td-id" value="' . $row['0'] . '">' . $row['0'] . '</a></td>
                        <td class="td-username">' . $row['1'] . '</td>
                        <td class="td-nome">' . $row['3'] . '</td>
                        <td class="td-cognome">' . $row['4'] . '</td>
                        <td class="td-dob">' . $row['5'] . '</td>
                        <td><button id="modifica">modifica</button><button id="elimina-' . $row['0'] . '">Elimina</td>
                    </tr>
                    </tbody>';
                        }
                    } else {
